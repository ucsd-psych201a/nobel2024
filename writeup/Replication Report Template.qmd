...
be outlined in the following Specific Models section. Note that as random assignment was employed, no control variables were added to the 
models."
...
number of products viewed. Model 4 was a multilevel linear regression estimated using restricted maximum likelihood estimation approach 
